...
The §14 build order is complete through step 6 — tokens, Box, Theme, the layout primitives, Button, Card — and repetition has begun with TextField — and the code phase is open. `CLAUDE.md` carries the current state and the standing rules; `docs/DECISIONS.md` is the spec.
