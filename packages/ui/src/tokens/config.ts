...
export const material = {
  ...
  /* THE PANE ROW MOVED UP 2026-09-18 with the region scale (judged over the photograph, both
     appearances): at 34/49/65 a card's or a popover's muted line over the orange was the
     weakest text on the page, and the pane sat one point over the control cell — the two
     scales were priced as one. Now control < pane < region at every thickness and in both
     modes (light 48 < 56 < 66 at regular; dark floating rises with it, keeping its lighten). */
  /* REGION-scale material (2026-09-18, Kushagra: a composer, a popover, a shell sidebar "need
     ...
     Members stamp `kui-region`: the shell panes, Sheet, Composer. Values are a first cut
     for the bench. */
  light: {
    thin: { alpha: [40, 48, 56], alphaHigh: [72, 77, 82], filter: "blur(2.4px) saturate(172.5%) brightness(1.03)", frost: "blur(8px) saturate(172.5%) brightness(1.03)", sheen: 13.6, control: { alpha: 30, filter: "blur(1.2px) saturate(140%) brightness(1.02)", frost: "blur(4px) saturate(140%) brightness(1.02)", filterHover: "blur(1.2px) saturate(140%) brightness(1.09)", filterLoud: "blur(1.2px) saturate(220%) brightness(1.1)" }, region: { alpha: 52, filter: "blur(4px) saturate(172.5%) brightness(1.03)", frost: "blur(12px) saturate(172.5%) brightness(1.03)" } },
    regular: { alpha: [56, 64, 72], alphaHigh: [80, 84, 88], filter: "blur(4px) saturate(207%) brightness(1.05)", frost: "blur(16px) saturate(207%) brightness(1.05)", sheen: 20.4, control: { alpha: 48, filter: "blur(2px) saturate(160%) brightness(1.04)", frost: "blur(8px) saturate(160%) brightness(1.04)", filterHover: "blur(2px) saturate(160%) brightness(1.09)", filterLoud: "blur(2px) saturate(220%) brightness(1.1)" }, region: { alpha: 66, filter: "blur(6px) saturate(207%) brightness(1.05)", frost: "blur(20px) saturate(207%) brightness(1.05)" } },
    thick: { alpha: [70, 74, 77], alphaHigh: [86, 89, 92], filter: "blur(5.6px) saturate(241.5%) brightness(1.06)", frost: "blur(24px) saturate(241.5%) brightness(1.06)", sheen: 25.5, control: { alpha: 66, filter: "blur(3.2px) saturate(180%) brightness(1.05)", frost: "blur(13.7px) saturate(180%) brightness(1.05)", filterHover: "blur(3.2px) saturate(180%) brightness(1.09)", filterLoud: "blur(3.2px) saturate(220%) brightness(1.1)" }, region: { alpha: 78, filter: "blur(8px) saturate(241.5%) brightness(1.06)", frost: "blur(28px) saturate(241.5%) brightness(1.06)" } },
  },
  dark: {
    thin: { alpha: [58, 66, 74], alphaHigh: [76, 80, 84], filter: "blur(2.4px) saturate(175.5%) brightness(0.92)", frost: "blur(8px) saturate(175.5%) brightness(0.92)", sheen: 2.75, control: { alpha: 48, filter: "blur(1.2px) saturate(162.5%) brightness(0.95)", frost: "blur(4px) saturate(162.5%) brightness(0.95)", filterHover: "blur(1.2px) saturate(162.5%) brightness(1.02)", filterLoud: "blur(1.2px) saturate(180%) brightness(1)" }, region: { alpha: 66, filter: "blur(4px) saturate(175.5%) brightness(0.92)", frost: "blur(12px) saturate(175.5%) brightness(0.92)" } },
    regular: { alpha: [72, 79, 86], alphaHigh: [84, 87, 90], filter: "blur(4px) saturate(195%) brightness(0.9)", frost: "blur(16px) saturate(195%) brightness(0.9)", sheen: 3.85, control: { alpha: 60, filter: "blur(2px) saturate(175%) brightness(0.94)", frost: "blur(8px) saturate(175%) brightness(0.94)", filterHover: "blur(2px) saturate(175%) brightness(1.02)", filterLoud: "blur(2px) saturate(180%) brightness(1)" }, region: { alpha: 78, filter: "blur(6px) saturate(195%) brightness(0.9)", frost: "blur(20px) saturate(195%) brightness(0.9)" } },
    thick: { alpha: [84, 86, 88], alphaHigh: [90, 92, 94], filter: "blur(5.6px) saturate(208%) brightness(0.88)", frost: "blur(24px) saturate(208%) brightness(0.88)", sheen: 4.95, control: { alpha: 74, filter: "blur(3.2px) saturate(187.5%) brightness(0.92)", frost: "blur(13.7px) saturate(187.5%) brightness(0.92)", filterHover: "blur(3.2px) saturate(187.5%) brightness(1.02)", filterLoud: "blur(3.2px) saturate(180%) brightness(1)" }, region: { alpha: 88, filter: "blur(8px) saturate(208%) brightness(0.88)", frost: "blur(28px) saturate(208%) brightness(0.88)" } },
  },
 ...
 */
export const floatingDark = { base: 88, alpha: { thin: 52, regular: 67, thick: 82 } } as const;
