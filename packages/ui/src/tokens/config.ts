...
export const material = {
  ...
  dark: {
    ...
    regular: { alpha: [67, 74, 81], alphaHigh: [84, 87, 90], filter: "blur(4px) saturate(195%) brightness(0.9)", frost: "blur(16px) saturate(195%) brightness(0.9)", sheen: 3.85, control: { alpha: 60, filter: "blur(2px) saturate(175%) brightness(0.94)", frost: "blur(8px) saturate(175%) brightness(0.94)", filterHover: "blur(2px) saturate(175%) brightness(1.02)", filterLoud: "blur(2px) saturate(180%) brightness(1)" }, region: { alpha: 78, filter: "blur(6px) saturate(195%) brightness(0.9)", frost: "blur(20px) saturate(195%) brightness(0.9)" } },
