 ...
 * that box moves the nearest thumb. The THUMB is the family's third member — a circle of
 * `mark(n)`, one line of the label's type, resting as every mark rests (the seal and the
