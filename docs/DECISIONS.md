...
- **Style-recalc tail at depth.** Every Box is a containment context and the engine re-evaluates container conditions on container resize. Invisible at demo scale; measured for real when the docs app has a deep tree. Accepted as the price of slot-correct responsiveness — not free, worth it.
