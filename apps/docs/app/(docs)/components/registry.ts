...
const DECLARED: Entry[] = [
  ...
  <AccordionItem value="shipping">
    ...
    parts: [
      ...
      { part: "AccordionPanel", blurb: "The content of the section. It opens and closes by height on a spring, and its text starts under the label of the heading" },
    ],
  },
  {
    slug: "alert-dialog",
